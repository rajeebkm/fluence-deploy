...
pub enum Opcode {
    ...
    Brif,
    /// `br_table x, label, JT`. (BranchTable)
    BrTable,
    /// `debugtrap`. (NullAry)
    Debugtrap,
    /// `trap code`. (Trap)
...
const OPCODE_FORMAT: [InstructionFormat; 182] = [
...
const OPCODE_CONSTRAINTS: [OpcodeConstraints; 182] = [
...
const OPERAND_CONSTRAINTS: [OperandConstraint; 82] = [
