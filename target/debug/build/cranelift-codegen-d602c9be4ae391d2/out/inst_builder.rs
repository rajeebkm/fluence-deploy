...
pub trait InstBuilder<'f>: InstBuilderBase<'f> {
    ...
    /// - label: Destination basic block
    /// - JT: A jump table.
    #[allow(non_snake_case)]
    fn br_table(self, x: ir::Value, label: ir::Block, JT: ir::JumpTable) -> Inst {
        self.BranchTable(Opcode::BrTable, types::INVALID, label, JT, x).0
    }
